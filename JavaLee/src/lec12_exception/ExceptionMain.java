...
public class ExceptionMain {
	public static void main(String[] args) {
		...
		try {
			...
			e.printStackTrace();
			// 에러가 콘솔창에 출력되는 시점과
			// sysout이 콘솔창에 출력되는 시점은 다르다.
			System.err.println("에러 구문");
...
//			a.printStackTrace();
			...
			System.out.println("인덱스를 넘어갔습니다.");
		}catch(Exception e) {
			System.out.println("나도 모르는 에러");
		}
...
//			e.printStackTrace();
		...
		try {
			...
			System.out.println("날짜 포맷을 yyyy.MM.dd로 맞춰 주세요.");
		}catch(Exception e) {
			System.out.println("나도 모르는 에러");
		}finally {
